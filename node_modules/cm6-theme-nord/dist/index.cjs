...
*/
const nordTheme = view.EditorView.theme({
    '&': {
        color: base04,
...
*/
const nordHighlightStyle = language.HighlightStyle.define([
    ...
    { tag: [highlight.tags.function(highlight.tags.variableName)], color: base07 },
    ...
    { tag: [highlight.tags.string], color: base0E },
    {
    ...
    { tag: [highlight.tags.monospace], color: base04, fontStyle: 'italic' },
    { tag: [highlight.tags.comment], color: base03, fontStyle: 'italic' },
...
const nord = [
    nordTheme,
    language.syntaxHighlighting(nordHighlightStyle)
];

exports.nord = nord;
exports.nordHighlightStyle = nordHighlightStyle;
